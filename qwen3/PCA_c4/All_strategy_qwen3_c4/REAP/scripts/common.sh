...
student_model_for_ratio() {
  case "$1" in
    ratio_50)
      echo "${QWEN3_REAP_RATIO_50:-${QWEN3_DIR}/compression_qwen3/REAP/artifacts/Qwen3-30B-A3B-Instruct-2507/c4/pruned_models/reap-renorm_true-seed_42-0.5}"
      ;;
    ratio_625)
      echo "${QWEN3_REAP_RATIO_625:-${QWEN3_DIR}/compression_qwen3/REAP/artifacts/Qwen3-30B-A3B-Instruct-2507/c4/pruned_models/reap-renorm_true-seed_42-0.375}"
      ;;
    ratio_75)
      echo "${QWEN3_REAP_RATIO_75:-${QWEN3_DIR}/compression_qwen3/REAP/artifacts/Qwen3-30B-A3B-Instruct-2507/c4/pruned_models/reap-renorm_true-seed_42-0.25}"
      ;;
    *)
