...
def dump_args_to_yaml(
    ...
    **all_args,
    ...
    arg_name_map = {
        ...
        "DatasetArgs": "ds_args",
        "ObserverArgs": "obs_args",
        "ClusterArgs": "cluster_args",
        "KdArgs": "kd_args",
        "EvalArgs": "eval_args",
        "MergeArgs": "merge_args",
        "PruneArgs": "prune_args",
    }
    positional_args = {}
    for idx, arg in enumerate(args):
        arg_name = arg_name_map.get(arg.__class__.__name__, f"arg_{idx}")
        if arg_name in positional_args or arg_name in all_args:
            arg_name = f"{arg_name}_{idx}"
        positional_args[arg_name] = arg
    all_args = {**positional_args, **all_args}
