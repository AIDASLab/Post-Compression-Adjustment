...
MODEL_ROOT="${MODEL_ROOT:-$(dirname "${EXP_ROOT}")}"
...
Examples:
  ...
  bash run_eval_method.sh HC-SMoE --categories safety_alignment
...
Environment:
  ...
  MODEL_ROOT=/path/to/checkpoints   Parent containing HC-SMoE/ and REAP/.
