...
COMPRESSED_MODELS_ROOT = Path(os.environ.get("COMPRESSED_MODELS_ROOT", EXP_ROOT))
...
def configure_local_runtime(category: str) -> None:
    ...
    for name in ("TMPDIR", "TORCHINDUCTOR_CACHE_DIR", "TRITON_CACHE_DIR", "VLLM_CACHE_ROOT", "VLLM_RPC_BASE_PATH", "HF_MODULES_CACHE", "NLTK_DATA"):
