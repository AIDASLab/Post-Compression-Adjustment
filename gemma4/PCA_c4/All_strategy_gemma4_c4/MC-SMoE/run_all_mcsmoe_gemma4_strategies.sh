...
echo "[All] Gemma4 MC-SMoE strategy recovery pipeline"
...
setup_env
python "${ROOT_DIR}/summarize_gpu_usage.py" --base_dir "$ROOT_DIR"   >"${ROOT_DIR}/logs/final_gpu_summary.stdout.log" 2>&1
