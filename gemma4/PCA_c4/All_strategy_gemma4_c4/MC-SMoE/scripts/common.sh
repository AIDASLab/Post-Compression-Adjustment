...
MCSMOE_COMPRESSED_ROOT="${MCSMOE_COMPRESSED_ROOT:-${GEMMA4_ROOT}/compression_gemma4/MC-SMoE}"
...
student_model_for_ratio() {
  case "$1" in
    ratio_50)
      echo "${MCSMOE_COMPRESSED_ROOT}/gemma4-26b-a4b-it-mcsmoe-50"
      ;;
    ratio_625)
      echo "${MCSMOE_COMPRESSED_ROOT}/gemma4-26b-a4b-it-mcsmoe-62_5"
      ;;
    ratio_75)
      echo "${MCSMOE_COMPRESSED_ROOT}/gemma4-26b-a4b-it-mcsmoe-75"
      ;;
    *)
