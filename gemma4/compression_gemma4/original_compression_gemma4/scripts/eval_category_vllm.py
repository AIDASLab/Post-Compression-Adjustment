#!/usr/bin/env python3
"""Run one vLLM lm-evaluation-harness category for one Gemma4 model."""
...
COMPRESSED_MODELS_ROOT = EXP_ROOT
...
def apply_model_runtime_patches(method: str) -> None:
    if method != "MC-SMoE":
        return
    os.environ["ORIGCOMP_PATCH_VLLM_GEMMA4"] = "1"
    root_text = str(ROOT)
...
def main() -> int:
    ...
    print(f"ORIGCOMP_PATCH_VLLM_GEMMA4={os.environ.get('ORIGCOMP_PATCH_VLLM_GEMMA4', '')}")
