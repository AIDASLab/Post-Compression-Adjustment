...
OUTPUT_DIR="${OUTPUT_ROOT:-${ROOT}}/gemma4-26b-a4b-it-mcsmoe-62_5"
...
MCSMOE_MODEL_DIR="${OUTPUT_DIR}" "${PYTHON_BIN:-python}" -u check_gemma4_mcsmoe_62_5.py \
