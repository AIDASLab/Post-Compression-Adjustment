...
OUTPUT_DIR="${OUTPUT_ROOT:-${ROOT}}/gemma4-26b-a4b-it-mcsmoe-50"
...
MCSMOE_MODEL_DIR="${OUTPUT_DIR}" "${PYTHON_BIN:-python}" -u check_gemma4_mcsmoe_50.py \
